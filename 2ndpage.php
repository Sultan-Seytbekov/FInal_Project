...
<body>
    <div class="sticky"> 
        <div class="nav scrollFade">
            <a href="index.html"><img class="toggle" src="https://cdn-images-1.medium.com/max/280/1*sW40iPA71NdEdbfp2zDVbA@2x.png"></a>
        </div>
        <a href="Shoqan.php"><div class="shoqan scrollFade" style="font-size: 18px; cursor: pointer; font-weight: 600; font-family: TTHoves, Arial,Helvetica,sans-serif; line-height: 2.3;">SHOQAN</div></a>
        <div class="main_img1">
      ...
      <div class="mainn scrollFade">
        ...
        <div class="qara scrollFade">
            <div class="qara_ishi">
                ...
                <p>Посетите бутик SHOQAN в Вашем городе, чтобы окунуться в особенную атмосферу мужского стиля и 
